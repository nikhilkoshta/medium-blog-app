    ...
    <footer className="bg-gray-800 text-white py-6 mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center space-x-4 mt-4">
          <a href="https://x.com/codingnikki" className="text-gray-400 hover:text-white" aria-label="Twitter">
          ...
          <a href="https://github.com/nikhilkoshta" className="text-gray-400 hover:text-white" aria-label="GitHub">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.linkedin.com/in/nikhilkoshta" className="text-gray-400 hover:text-white" aria-label="LinkedIn">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
